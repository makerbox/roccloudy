...
def add_product_to_cart
  ...
  htmlstring += '<a data-qty="'+qty+'" data-price="'+prodprice.to_s+'" data-disable-with="removing..." class="btn btn-warning remove-btn" data-remote="true" href="/products/' + @newquantity.id.to_s + '/remove">remove</a>' 
  htmlstring += '</div>'
